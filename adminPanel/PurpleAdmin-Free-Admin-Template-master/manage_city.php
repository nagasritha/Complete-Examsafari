...
$cities = mysqli_query($conn,"SELECT * from examCities");
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="d-flex flex-row justify-content-center">
                        <img src="../../assets/php/Images/<?php echo $city["image"]?>"/>
                      </div> 
                      </div>
              ...
              <div class="signup-popup-container" id="service-Edit-card">
                ...
                <div class="row">   
                <h4 class="card-title col-10">Edit City</h4>
                ...
                <hr/>
                <form class="form-sample" id="editcityForm">
                    <div class="row mt-5">
                      <div class="col-xl-6">
                    ...
                    <div class="row">
                      <div class="col-xl-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label" for="image">City Image</label>
                          <div class="col-sm-9">
