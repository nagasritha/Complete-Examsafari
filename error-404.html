...
<head>
	...
	<!-- Title -->
	<title>TechSoft - IT Solution & Business Services HTML5 Responsive Website Template</title>
	<!-- Google Fonts -->
		...
		<div class="techSoft-responsive-nav techSoft-fixed-nav">
			<div class="container">
				<div class="techSoft-responsive-menu">
					<div class="logo">
						<a href="index.html"> <img src="assets/img/logo-black.png" alt="logo"> </a>
					</div>
				</div>
			</div>
		</div>
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item"> <a href="#" class="nav-link">Pages <i class="fas fa-chevron-down"></i></a>
								<ul class="dropdown-menu">
									...
									<li class="nav-item"> <a href="terms-condition.html" class="nav-link">Terms & Conditions</a> </li>
